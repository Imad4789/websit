# AGENTS.md – Center Tyani

Premium educational marketing website for Center Tyani tutoring center (Belfaa, Morocco). Single-page application with a fixed navbar and scroll-anchored sections. Built on TanStack Start, deployed to Netlify.

## Project Overview

Center Tyani tutoring center website with full marketing landing page. No AI assistant, no product catalog. The `src/data/products.ts` and `src/routes/products/` are leftover scaffold files and are unused.
